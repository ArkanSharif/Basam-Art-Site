...
<div class="nav-bar">
    ...
    <ul class="nav-links-container me-3">
        <li class="nav-link"><a href="humaines+.php" class="link">Humaines+</a></li>
        <li class="nav-link"><a href="theschoolhour.php" class="link"> The school hour</a></li>
        <li class="nav-link"><a href="hitman.php" class="link active"> HITMAN</a></li>
        <li class="nav-link"><a href="sketches.php" class="link">Sketches</a></li>
        <li class="nav-link"><a href="personal.php" class="link">Personal stuff</a></li>
    </ul>
    <ul class="personal-nav-links-container me-3">
        <li class="nav-link">About me</li>
        <li class="nav-link">Clients</li>
        <li class="nav-link">Other links</li>
    </ul>
</div>
